...
int main() {
	...
	printf (" Selecciona tu estilo");
		scanf("%d",&numero);
            printf (" Segun el estilo que seleccionaste y con el que te identificas, se te proporcionar&c una recomendación de prendas\n ",160);
		switch (numero) {
		case 1:
		...
		case 2:
			...
			break;
		case 3:
			printf("Graffitis, ropa varias tallas m%cs grande, gorras con la visera hacia atr%cs y, como no, m%csica rap. Suelen llevar tambi%cn joyas grandes, cadenas doradas, anillos y relojes, combinados con deportivas grandes.", 160, 160, 163, 130 );
			break;
		case 4:
		...
		case 7:
			...
			break;
		default:
			printf("Intenta con un nuevo estilo\n");
		} //fin switch
