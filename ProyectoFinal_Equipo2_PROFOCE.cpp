...
int main(){
	...
	printf (" Selecciona tu estilo ");
		...
		scanf("%d",&numero); 
            printf (" Segun el estilo que seleccionaste y con el que te identificas, se te proporcionar%c una recomendaci%cn de prendas\n y un costo ",160,162);
	...
	cambio=pago-costo;
		...
		case 7:
			...
			break;
			default: 
			printf(" Encontraremos, un estilo para ti ");
		}
		 //fin switch
